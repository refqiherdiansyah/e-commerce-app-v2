...
const OurStore = () => {
    const [grid, setGrid] = useState(4); // Initialize with default value
    ...
    return (
        <>
            ...
            <Container class1="store-wrapper home-wrapper-2 py-5">
                <div className="row">
                    <div className="col-3">
                        <div className="filter-card nb-3">
                            ...
                            <div className="filter-card nb-3">
                                ...
                                <div>
                                    <div className="random-products mb-3 d-flex">
                                        ...
                                        <div className="w-50">
                                            <h5>
                                                Monitor 10 pack multi colored for students
                                            </h5>
                                            <ReactStars
                                                count={5}
                                                size={24}
                    ...
                    <div className="col-9">
                        <div className="filter-sort-grid mb-4">
                            <div className="d-flex justify-content-between align-items-center">
                                <div className="d-flex align-items-center gap-10">
                                <p className="mb-0 d-block" style={{ width: "100px" }}>SortBy</p>
